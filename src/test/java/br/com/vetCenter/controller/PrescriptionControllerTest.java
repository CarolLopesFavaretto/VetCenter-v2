...
public class PrescriptionControllerTest {
    ...
    @Test
    public void shouldCreatedPrescriptionByGuardian() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.post(
                                "/prescription/guardian/{guardianId}/animal/{animalId}" +
    ...
    @Test
    public void shouldUpdatedPrescriptionByGuardian() throws Exception{
        ...
        PrescriptionRequest requestUpdated = PrescriptionRequest.builder()
                .date(LocalDate.now())
                .medication("probiotico")
                .build();

        mvc.perform(MockMvcRequestBuilders
                        .put("/prescription/guardian/{guardianId}/animal/{animalId}" +
                                        "/consultations/{consultationId}/prescriptions/{prescriptionId}",
                                guardianResponse.getId(), animal.getId(), consultation.getId(), prescription.getId())
                ...
                .andExpect(mvcResult -> {
                    ...
                    assertThat(consultationUp.getNameVeterinary()).isEqualTo(consultation.getNameVeterinary());
                    assertThat(consultationUp.getCause()).isEqualTo(consultation.getCause());
                    assertThat(consultationUp.getObservations()).isEqualTo(consultation.getObservations());
                    assertThat(consultationUp.getDate()).isEqualTo(consultation.getDate());
                    assertThat(consultationUp.getValue()).isEqualTo(consultation.getValue());
                    assertThat(consultationUp.getRegress()).isEqualTo(consultation.getRegress());

                    Prescription prescriptionUp = consultationUp.getPrescriptions().get(0);
                    assertThat(prescriptionUp.getDate()).isEqualTo(requestUpdated.getDate());
                    assertThat(prescriptionUp.getMedication()).isEqualTo(requestUpdated.getMedication());
                });
    }

    @Test
    public void shouldDeletedPrescriptionByGuardian() throws Exception{
        ...
        mvc.perform(MockMvcRequestBuilders
                        .delete("/prescription/guardian/{guardianId}/animal/{animalId}" +
                                        "/consultations/{consultationId}/prescriptions/{prescriptionId}",
                                guardianResponse.getId(), animal.getId(), consultation.getId(), prescription.getId())
                        .content(objectMapper.writeValueAsString(prescription))
                        .contentType(MediaType.APPLICATION_JSON)
